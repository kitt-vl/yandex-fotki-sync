...
is $sync->scan('t')->size, 11,
  'Right number of total pictures in "t" directory';

#is $sync->scan(catfile('t', 'суб дир 2'))->size, 6, 'Right number of total pictures in subdir';
is $sync->scan( catfile( 't', 'testdir 1' ) )->size, 3,
  'Right number of total pictures "testdir 1" dir';
